...
TEST_F( SpacePersisterTests, restoreLuaTest )
{
	...
	co::RefPtr<ca::ISpacePersister> persister2 = createPersister( fileName );

	persister2->restoreLua( 1 );

	ca::ISpace * spaceRestored = persister2->getSpace();
